...
local animatorLib = try_require("jackzanimatorlib", true)
if SCRIPT_SOURCE == "MANUAL" then
...
function spawn_build(build, isPreview, previewFunc, previewData)
    ...
    if baseHandle then
        Log.debug("spawned base " .. baseHandle .. " preview: " .. (isPreview and "yes" or "no"))
        if isPreview then
